...
mod tests {
    ...
    fn new_cart() {
        ...
        let mut item1 = cart::item::Item::new(1, 2, &mut iphone);
        let mut item2 = cart::item::Item::new(2, 1, &mut samsung);
    ...
    fn add_new_item() {
        ...
        let mut item1 = cart::item::Item::new(3, 5, &mut nokia);
    ...
    fn get_sub_total() {
        ...
        let item1 = cart::item::Item::new(3, 2, &mut nokia);
