...
mod tests {
    ...
    fn new_cart() {
        ...
        let iphone = cart::Product::new(1, &mut iphone_name, 8000.0);

        let mut samsung_name = String::from("samsung galaxy 1");
        let samsung = cart::Product::new(2, &mut samsung_name, 8000.0);
    ...
    fn add_new_item() {
        ...
        let nokia = cart::Product::new(3, &mut nokia_name, 8000.0);
